...
public class WireFramePagePrincipale {
  public static void main(String[] args) {
     ...
     element21.setBounds(54, 128, 147, 87);
     element21.setFont(CustomFontLoader.loadFont("./resources/fonts/Lexend.ttf", 26));
     element21.setForeground(Color.decode("#000"));
     panel.add(element21);

     JLabel element22 = new JLabel("Les filtressLes filtressLes filtressLes filtressLes filtressLes filtressLes filtressLes filtressLes filtressLes filtressLes filtressLes filtress");
     element22.setBounds(60, 213, 120, 145);
     ...
     element24.setBounds(228, 173, 140, 158);
